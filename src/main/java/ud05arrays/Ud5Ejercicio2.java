...
public class Ud5Ejercicio2 {
	 ...
	 * de String[] args genere un array de enteros con los N primeros terminos de la
	 * sucesion de Fibonacci
	 * 
	 * La sucesion de Fibonacci tiene fijos los dos primeros terminos fijos F(0) = 0
	 * F(1) = 1
	 * 
	 * A partir del tercero se generan en base a los anteriores F(N) = F(N-2) + F
	 * (N-1)
	 * 
	 * @param args
	 */
	 ...
	 * [fibo(0),fibo(1),fibo(2),fibo(3),fibo(4)]
	 * 
	 * @param terminos longitud del array
	 * @return el array con todos los terminos de fibonacci calculados para cada
	 *         posicion
	 */
	public static long[] fibonacci(int terminos) {

		long[] fib = new long[terminos];
	 ...
	 * 
	 * Para enesimo = 0 -> 0; Para enesimo = 1 -> 1; Para enesimo = N, tal que N > 1
	 * -> fibo(N-2)+fibo(N-1)
	 * 
	...
	public static long fibo(int enesimo) {
		...
		if (enesimo == 0) {
			...
			return fibo(enesimo - 1) + fibo(enesimo - 2);
		}
